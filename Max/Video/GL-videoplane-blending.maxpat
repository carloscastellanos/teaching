...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.0, 128.0, 140.0, 21.0 ],
					"style" : "",
					"text" : "read Sequence01_1.mov"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 144.0, 346.0, 314.0, 24.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 8.0, 286.0, 110.0, 49.0 ],
					"style" : "",
					"text" : "jit.window glvidblend @depthbuffer 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 64.0, 121.147247, 276.0 ],
					"proportion" : 0.39,
					"rounded" : 30,
					"style" : ""
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 7/Packages/Max for the Visual Arts/patchers/Toolbox/imi_objects",
				"patcherrelativepath" : "../../Packages/Max for the Visual Arts/patchers/Toolbox/imi_objects",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "IMIMovies.txt",
				"bootpath" : "~/Documents/Max 7/Packages/Max for the Visual Arts/patchers/z",
				"patcherrelativepath" : "../../Packages/Max for the Visual Arts/patchers/z",
				"type" : "TEXT",
				"implicit" : 1
			}
 ],
