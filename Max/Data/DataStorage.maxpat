...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 840.0, 353.0, 129.0, 10.0 ],
					"size" : 100.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 780.0, 409.0, 46.0, 18.0 ],
					"presentation_rect" : [ 767.0, 428.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 840.0, 376.0, 148.0, 29.0 ],
					"presentation_rect" : [ 871.0, 425.0, 0.0, 0.0 ],
					"text" : "non-graphical version of itable (double-click to see graph)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 780.0, 376.0, 49.0, 18.0 ],
...
,
					"showeditor" : 0,
					"size" : 128,
					"table_data" : [ 0, 117, 117, 117, 106, 107, 109, 111, 112, 114, 114, 114, 114, 114, 114, 114, 114, 114, 114, 88, 89, 89, 90, 23, 24, 25, 26, 27, 28, 85, 85, 84, 83, 83, 81, 79, 77, 75, 73, 72, 77, 77, 77, 77, 77, 77, 78, 78, 78, 78, 78, 78, 79, 79, 80, 80, 80, 81, 81, 81, 82, 82, 83, 83, 84, 84, 85, 85, 86, 86, 87, 88, 88, 89, 89, 90, 90, 91, 91, 92, 93, 94, 95, 95, 96, 97, 99, 101, 103, 108, 111, 115, 120, 127, 127, 127, 127, 127, 127, 127, 126, 126, 125, 124, 123, 122, 121, 121, 121, 120, 120, 119, 118, 91, 91, 91, 91, 91, 91, 91, 10, 10, 10, 10, 10, 10, 10, 10, 10 ],
					"text" : "table"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 455.0, 150.0, 18.0 ],
					"text" : "- - -"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 180.0, 215.0, 202.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 585.0, 605.0, 66.0, 52.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.0, 575.0, 36.0, 16.0 ],
					"text" : "write"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 585.0, 485.0, 73.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 485.0, 37.0, 18.0 ],
					"text" : "COLL"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 585.0, 530.0, 41.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 675.0, 635.0, 111.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 720.0, 575.0, 107.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 705.0, 545.0, 67.0, 16.0 ],
					"text" : "3 4.5 6.7 8.9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 690.0, 515.0, 56.0, 16.0 ],
					"text" : "2 3 6 9 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 675.0, 485.0, 128.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 500.0, 220.0, 144.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 675.0, 605.0, 67.0, 18.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 45.0, 145.0, 75.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 699.5, 538.0, 684.0, 538.0, 684.0, 590.0, 684.5, 590.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 714.5, 567.0, 684.0, 567.0, 684.0, 602.0, 684.5, 602.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 729.5, 597.0, 684.5, 597.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 594.5, 597.0, 684.5, 597.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 684.5, 629.0, 776.5, 629.0 ],
					"source" : [ "obj-9", 0 ]
				}
