...
public class XBeeConfigTool extends PApplet {
...
public void configureXBeeModem() {
...
public void readSettingsFromXBeeModem() {
  if (portRadioButtons.getSelectedIndex() < 0) {
    statusTextLabel.setLabel("Please select a proper serial port.");
    return;
  }
...
public void showSetting(int command, String reply) {
  switch(command){
  case 0: // Baud Rate
...
public boolean gotOkayFromXBeeModem() {
  delay(100);
...
public String getReplyFromXBeeModemFor(String atCommand) {
...
public boolean enterCommandMode(String portName) {
...
public boolean exitCommandMode() {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#ffffff", "XBeeConfigTool" });
  }
}
