...
>[!NOTE]
>_This document covers the policies and procedures for IGME-480. This document includes only limited information about topic units, specific assignments and readings. More details on these can be found on myCourses._
...
- Other materials/resources needed for specific assignments will be mentioned as needed
...
Assignments are not simply about writing code. Every assignment will have associated readings, research and reflective writing components (discussed below). Some will require fieldwork. In addition, your instructor will provide important historical context, show examples and provide other notes and resources relevant to the assignment topic/theme. Tentatively, there are 6-8 assignments:
