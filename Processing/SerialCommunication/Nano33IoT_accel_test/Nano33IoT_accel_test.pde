...
=========================================================
==  Arduino Nan033IoT Accelerometer (LSM6DS3) example  ==
==  3D Tilt example                                    ==
==                                                     ==
==  Carlos Castellanos                                 ==
==  January 31 2023                                    ==
...
Note this will work for any accerometer that gives you the angle in radians
Make sure to use a comma as delimiter when you send serial from Arduino
