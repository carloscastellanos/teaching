...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 461.0, 403.5, 47.0, 18.0 ],
					"text" : "print 4th"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 6,
					"outlettype" : [ "bang", "float", "last", "is", "int", "first" ],
					"patching_rect" : [ 461.0, 328.5, 87.0, 18.0 ],
					"text" : "t b f last is i first"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 461.0, 305.5, 53.0, 18.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 285.0, 631.0, 47.0, 18.0 ]
				}
